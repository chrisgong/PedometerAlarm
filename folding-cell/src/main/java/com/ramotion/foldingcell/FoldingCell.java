...
public class FoldingCell extends RelativeLayout {
    ...
    private IUnfoldedListener mListener;
    ...
    public interface IUnfoldedListener {
        void onUnfolded(boolean unfolded);
    }

    public void setUnfoldedListener(IUnfoldedListener listener) {
